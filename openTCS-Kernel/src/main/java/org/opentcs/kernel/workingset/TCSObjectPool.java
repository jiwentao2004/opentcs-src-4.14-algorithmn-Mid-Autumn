...
public class TCSObjectPool {
  ...
  /**
   * Shares Map containing all vehicles' information to all vehicleControllers in different THREAD.
   */
  private final Map<String, String> sharedMap = new ConcurrentHashMap<>();

  /**
   * Shares locking information of all paths/points in different THREAD.
   * Map(pointName, vehicleName)
   */
  private final Map<String, String> sharedLockInformation = new ConcurrentHashMap<>();
  /**
   * Shares topology information of all removed paths in different THREAD.
   */
  private final Map<String, List<TCSObjectReference<Path>>> sharedTopologyInformation = new ConcurrentHashMap<>();

  public Map<String, List<TCSObjectReference<Path>>> getSharedTopologyInformation() {
    return sharedTopologyInformation;
  }

  public Map<String, String> getSharedLockInformation() {
    return sharedLockInformation;
  }
